![LocatorBar: The Ultimate Edition](assets/banner.png)

# LocatorBar — The Ultimate Edition 🌟

**An advanced, RPG & MMO-style HUD compass and player/waypoint locator bar for Minecraft (1.20 – 26.2)!**

[![Modrinth](https://img.shields.io/badge/Modrinth-Download%20Now-00AF5C?style=for-the-badge&logo=modrinth)](https://modrinth.com/mod/locatorbar-ultimate)
[![CurseForge](https://img.shields.io/badge/CurseForge-Download%20Now-F16436?style=for-the-badge&logo=curseforge)](https://www.curseforge.com/projects/1658929)
[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github)](https://github.com/Krylo-60/LocatorBar-Ultimate)
...
- Continuous smooth degree tick marks along the bar (15° & 30° increments).
...
- **Target Lock Glow**: When aiming directly toward a target (±2.5°), a gentle pulse glow confirms you are on target.
...
- Automatically saved in config without needing compasses in your inventory.
...
- **OLED Minimal**: Pure floating markers with zero background clutter.
- Plus: **Frosted Glass**, **Neon Cyan**, **Amethyst**, **Emerald**, **Gold**, and **Nether Crimson**.

### 🔊 Custom Audio Sound Packs & Fade Animations
...
- Visually move and place the locator bar anywhere on your screen with grid snapping.

---

## 📦 Supported Loaders & Minecraft Versions (1.20 – 26.2)

- **Fabric & Quilt**: 1.20 through 26.2
- **NeoForge & Forge**: 1.20 through 1.21.4
- **Paper / Spigot / Purpur / Folia Server Plugin**: 1.20 through 26.2+ (Dedicated server plugin syncing player locations and waypoints with client HUDs, with full Vanish/Stealth support)
...
*Keybindings can be customized anytime in **Options -> Controls -> Key Binds -> Locator Bar**.*
